import { Box, Heading, HStack, Text,Icon, VStack, Grid, Stack } from '@chakra-ui/react'
import React from 'react'
import {AiFillAndroid,AiFillApple ,AiFillFacebook,AiFillLinkedin,AiFillTwitterSquare } from 'react-icons/ai'
...
export default function Footer() {
  return (
    <Box pl='10%' pr='10%' pt='20px' pb='20px' bg='gray.200' >
        <Stack justifyContent={'space-between'} pb='20px' flexDir={{base:"column",md:'row'}} >
