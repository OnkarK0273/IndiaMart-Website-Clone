import { Box, Button, Flex, FormControl, FormLabel, Icon, Input, Modal, ModalCloseButton, ModalContent, ModalFooter, ModalHeader, ModalOverlay, Text, useDisclosure, useToast } from '@chakra-ui/react'
import React, { useEffect, useState } from 'react'
import { useDispatch, useSelector } from 'react-redux'
import BulbsCard from './BulbsCard'
import { MdAddBox} from 'react-icons/md'
import { addBulbs, getBulbs, patchBulbs } from '../../../redux/sell/sell.action'
export default function BulbsPanal() {
    ...
    const setDetails = (title,price,Wattage,application,Thickness,Brand,supplier,supplier_Addres,mob,img1,img2,id) => {
      settitle(title)
      setprice(price)
      setWattage(Wattage)
