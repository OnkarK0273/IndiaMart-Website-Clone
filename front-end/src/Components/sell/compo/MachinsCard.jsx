...
import { deleteMachins, getMachins } from "../../../redux/sell/sell.action";
//   import { deleteProductProduct } from "../redux/Admin/admin.action";

export default function MachinesCard({ product, setDetails }) {
  ...
  const handleDelete = () => {
    ...
    dispatch(deleteMachins(id, headers)).then(() => {
