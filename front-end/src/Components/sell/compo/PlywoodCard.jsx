...
export default function PlywoodCard({ product, setDetails }) {
    ...
    const {
      _id,
      title,price,quan,size,Color,UsageApplication,Thickness,Brand,supplier,supplier_Addres,mob,img1,img2
    } = product;
          ...
          >
            ...
            >
              <Button
                ...
                bg="gray.200"
                onClick={() => {
                    setDetails(title,price,quan,size,Color,UsageApplication,Thickness,Brand,supplier,supplier_Addres,mob,img1,img2)
                }}
              >
                Edit
              </Button>
